...
#adding a task 
Add a task by filling the boxes about taskName and taskdescription and selecting whether a task is finished or yet to be done 
based on that the task gets updated 
<img width="1117" height="330" alt="image" src="https://github.com/user-attachments/assets/0a1a77af-b848-436f-a222-925c75756563" />

#editing a task
edit the task by clicking edit button , fill the details and click save 
when the edit button is clicked the editing bar will show up in the task position
<img width="1131" height="342" alt="image" src="https://github.com/user-attachments/assets/ffc825e1-d6ba-4fd3-8284-6da38ec3c34e" />

#after modification
<img width="1126" height="328" alt="image" src="https://github.com/user-attachments/assets/427653f6-3267-48c1-a67f-38f3a32976af" />
